<template>
  <div class="auth-page">
    ...
    <div class="auth-card">
      ...
      <div v-if="step === 3" class="confirm-email-step">
        <div class="confirm-icon">📧</div>
      ...
      <div v-if="step < 3" class="demo-hint">
...
.confirm-data {
  width: 100%; background: var(--gray-50); border-radius: var(--radius-md);
...
.confirm-email-step h3 { font-size: 22px; font-weight: 700; }
.confirm-email-step p  { font-size: 14px; color: var(--gray-600); line-height: 1.6; }
.hint { font-size: 13px !important; color: var(--gray-400) !important; }
